...
function getMinVersionForCollab(
	...
	containerRuntimeForLoading: string | undefined,
): MinimumVersionForCollab {
	if (containerRuntimeForLoading === undefined) {
		...
		return containerRuntimeVersion as MinimumVersionForCollab;
	}
	...
	return (
		semver.compare(containerRuntimeVersion, containerRuntimeForLoading) <= 0
			? containerRuntimeVersion
			: containerRuntimeForLoading
	) as MinimumVersionForCollab;
}
